...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '117.216.101.174'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '117.216.101.174:8080')) if not ON_HEROKU or getenv('FQDN', '117.216.101.174:8080') else APP_NAME+'.herokuapp.com'
